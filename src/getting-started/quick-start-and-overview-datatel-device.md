...
# Quick Start & Overview - Datatel Device

The Quick Start Guide is available as&#x20;

1. [a video guide](quick-start-and-overview-datatel-device.md#id-1.-quick-start-video) or&#x20;
2. [a step-by-step guide with text & screenshots](quick-start-and-overview-datatel-device.md#id-2.-step-by-step-text-and-screenshot-guide)
